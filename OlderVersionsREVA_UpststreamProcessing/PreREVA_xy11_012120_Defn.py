...
while ai1<len(argv):
    ...
    if not('=' in a1) and (a1.lower().endswith('dfam.hits.gz') or a1.lower().endswith('dfam.hits') or a1.lower()=='dfam' or a1.lower()=='-dfam'):
        ...
        DFAMCount1=True
        continue
    if not('=' in a1) and a1.lower().endswith('.9re'):
        IndexFile1=a1.strip()
        continue
...
if IndexFile1=='default':
    IndexFile0='PreREVAIndex_'+RefAbbrev1+'_k'+str(klen1)+'_b'+str(BitsIndexed1)+'_wv1.9rf'
    if Debug1:
...
for (f1,f2,n00) in zip(FiLR1,FiLR2,FiLN1):
    ...
    for L0,M0 in izip_longest(F1,F2,fillvalue=''):
        ...
        if filelinenum % ReportIntervalA==0:
            ...
            if FirstKTable1:
                if SingleReadMode1==0:
                    LogNote1('    Average_FirstKValues: StartR1=' + '{0:.2f}'.format(Moment1(J0A))+
                ...
                if FirstKTable1:
                    ...
                    LogNote1('    Average_FirstKValues: StartR1=' + '{0:.2f}'.format(Moment1(J2A))+
        ...
        if filelinenum == LinesToProcessA:
            ...
            break
        if Roton0==0:    ##only pay attention to the second line of each 4 (fastq file structure)
            PreFilters1 += 1
            exptlinenum1+=1
            ...
            x2=ulen1
            if lL0>=klen1:
                b0 = array.array('B',L0.translate(Tr2))
                k0 = 0
                    ...
                    if x1==ulen1:
                        for j1 in xrange(lL0-1,0,-1):
                            ...
                            if x1<ulen1:
                                break
            if lM0>=klen1:
                b2 = array.array('B',M0.translate(Tr2))
                k2 = 0
                j2 = 0
            ...
            if RClass0>0 and RClass2>0:
                ...
                if c1==c3 and klen1<EsPair1<=ReadSeparationMax1:
                    ...
                    RClass02 = 3
            if RClass0==2 or RClass2==2 or RClass02==2:
                PassFilters1 += 1
